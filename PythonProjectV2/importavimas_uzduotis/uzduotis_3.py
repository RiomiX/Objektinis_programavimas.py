...
try:
    ...
    print(os.getcwd())
    os.chdir('Z:\\Pamokos\\PythonProjectV2\\importavimas_uzduotis\\modules')

with open('kursas.py', 'r') as file:
    file.close()

with open('python_kursas.py', 'r') as file:
    file.close()

PythonKursas.destyti(print)
Kursas.destyti(print)
